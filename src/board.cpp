...
void Board::init() {
    bitboards[std::make_pair(White, Pawn)] = 0b11111111 << 8;
    bitboards[std::make_pair(Black, Pawn)] = 0b11111111 << 48;

    bitboards[std::make_pair(White, Knight)] = 0b01000010;
    bitboards[std::make_pair(Black, Knight)] = 0b01000010 << 56;

    bitboards[std::make_pair(White, Bishop)] = 0b00100100;
    bitboards[std::make_pair(Black, Bishop)] = 0b00100100 << 56;

    bitboards[std::make_pair(White, Rook)] = 0b10000001;
    bitboards[std::make_pair(Black, Rook)] = 0b10000001 << 56;

    bitboards[std::make_pair(White, Queen)] = 0b1000;
    bitboards[std::make_pair(Black, Queen)] = 0b1000 << 56;

    bitboards[std::make_pair(White, King)] = 0b10000;
    bitboards[std::make_pair(Black, King)] = 0b10000 << 56;
}
